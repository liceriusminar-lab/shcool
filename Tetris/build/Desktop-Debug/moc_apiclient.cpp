...
template <> constexpr inline auto ApiClient::qt_create_metaobjectdata<qt_meta_tag_ZN9ApiClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'scoresReceived'
        QtMocHelpers::SignalData<void(const QVector<ScoreEntry> &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Signal 'nickChecked'
...
void ApiClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->scoresReceived((*reinterpret_cast<std::add_pointer_t<QList<ScoreEntry>>>(_a[1]))); break;
        case 1: _t->nickChecked((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ApiClient::*)(const QVector<ScoreEntry> & )>(_a, &ApiClient::scoresReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ApiClient::*)(bool , const QString & )>(_a, &ApiClient::nickChecked, 1))
            return;
    }
}
...
// SIGNAL 0
void ApiClient::scoresReceived(const QVector<ScoreEntry> & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ApiClient::nickChecked(bool _t1, const QString & _t2)
{
